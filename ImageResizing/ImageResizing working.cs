...
public class ImageResizing
    ...
    public bool SaveImages(int i, string saveFolderName, string width, string height, string resolution)
    {
        try
        {
            ...
            Resizing(Images[i], Width[i], Height[i], Resolution[i], saveFolderName, ImagesFiles[i], format);
    ...
    private void Resizing(Image image, int width, int height, float resolution, string saveFolderName, string imageFile, ImageFormat format)
    {
