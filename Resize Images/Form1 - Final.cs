...
namespace ResizeImagesApplication
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            fileLogger = new FileLogger($"{Environment.CurrentDirectory}\\Logs.txt");
                ...
                else
                {
                    switch (status)
                    {
                        ...
                        case FilesStatus.Loading:
                            ...
                            {
                                int i;
                                imagesResizing = new ImageResizing(openFileDialog1.FileNames.ToList<string>()); //filesNames
                                //MessageBox.Show("Please wait...");
                                ...
                                fileLogger.LogInfo($"{i.ToString()} image/s selected");
                                selectedImagesLabel.Text = $"{i.ToString()} image/s selected";
                        ...
                        case FilesStatus.Saving:
                            ...
                            for (int i = 0; i < imagesResizing.Length; i++)
                            {
                                ...
                                saveImageFlag = imagesResizing.SaveImages(i, saveFolderName, width, height, resolution);
                                backgroundWorker1.ReportProgress(imagesResizing.Percentage);
